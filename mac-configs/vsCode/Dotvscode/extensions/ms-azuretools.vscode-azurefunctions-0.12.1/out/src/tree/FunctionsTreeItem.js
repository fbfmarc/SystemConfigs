...
class FunctionsTreeItem extends vscode_azureextensionui_1.AzureParentTreeItem {
    constructor() {
        super(...arguments);
    ...
    loadMoreChildrenImpl(clearCache) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const funcs = this._nextLink ? yield this.root.client.listFunctionsNext(this._nextLink) : yield this.root.client.listFunctions();
            ...
            return yield vscode_azureextensionui_1.createTreeItemsWithErrorHandling(this, funcs, 'azFuncInvalidFunction', (fe) => __awaiter(this, void 0, void 0, function* () {
                const treeItem = new FunctionTreeItem_1.FunctionTreeItem(this, fe);
