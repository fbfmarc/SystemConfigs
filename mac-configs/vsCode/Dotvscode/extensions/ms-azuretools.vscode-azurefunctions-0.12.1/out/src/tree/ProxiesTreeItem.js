...
class ProxiesTreeItem extends vscode_azureextensionui_1.AzureParentTreeItem {
    constructor() {
        super(...arguments);
    ...
    loadMoreChildrenImpl() {
        return __awaiter(this, void 0, void 0, function* () {
            let proxiesJson;
            try {
                const result = yield vscode_azureappservice_1.getFile(this.root.client, this._proxiesJsonPath);
            ...
            try {
                ...
                return Object.keys(this._proxyConfig.proxies).map((name) => new ProxyTreeItem_1.ProxyTreeItem(this, name));
            }
            catch (err) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._deletingProxy) {
                ...
                try {
                    ...
                    this._etag = yield vscode_azureappservice_1.putFile(this.root.client, data, this._proxiesJsonPath, this._etag);
