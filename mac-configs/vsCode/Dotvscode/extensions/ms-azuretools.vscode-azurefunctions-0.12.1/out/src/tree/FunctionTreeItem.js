...
class FunctionTreeItem extends vscode_azureextensionui_1.AzureTreeItem {
    ...
    deleteTreeItemImpl() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deleting = localize_1.localize('DeletingFunction', 'Deleting function "{0}"...', this._name);
            const deleteSucceeded = localize_1.localize('DeleteFunctionSucceeded', 'Successfully deleted function "{0}".', this._name);
            ...
            yield vscode_1.window.withProgress({ location: vscode_1.ProgressLocation.Notification, title: deleting }, () => __awaiter(this, void 0, void 0, function* () {
                extensionVariables_1.ext.outputChannel.appendLine(deleting);
                yield this.root.client.deleteFunction(this._name);
                vscode_1.window.showInformationMessage(deleteSucceeded);
    ...
    initializeTriggerUrl() {
        return __awaiter(this, void 0, void 0, function* () {
            const triggerUrl = new url_1.URL(`${this.root.client.defaultHostUrl}/api/${this._name}`);
    ...
    getKey() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield vscode_azureappservice_1.functionsAdminRequest(this.root.client, urlPath);
            try {
