...
class JavaProjectCreator extends IProjectCreator_1.ProjectCreatorBase {
    constructor(functionAppPath, actionContext) {
    ...
    addNonVSCodeFiles() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield mavenUtils_1.mavenUtils.executeMvnCommand(this.telemetryProperties, extensionVariables_1.ext.outputChannel, tempFolder, 'archetype:generate', mavenUtils_1.mavenUtils.formatMavenArg('DarchetypeGroupId', 'com.microsoft.azure'), mavenUtils_1.mavenUtils.formatMavenArg('DarchetypeArtifactId', 'azure-functions-archetype'), mavenUtils_1.mavenUtils.formatMavenArg('DgroupId', groupId), mavenUtils_1.mavenUtils.formatMavenArg('DartifactId', artifactId), mavenUtils_1.mavenUtils.formatMavenArg('Dversion', version), mavenUtils_1.mavenUtils.formatMavenArg('Dpackage', packageName), mavenUtils_1.mavenUtils.formatMavenArg('DappName', appName), '-B' // in Batch Mode
                );
