...
function createNewProject(actionContext, functionAppPath, language, runtime, openFolder = true, templateId, functionName, caseSensitiveFunctionSettings) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield vscode_1.window.withProgress({ location: vscode_1.ProgressLocation.Notification, title: localize_1.localize('creating', 'Creating new project...') }, () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield projectCreator.addNonVSCodeFiles(ProjectSettings_1.convertStringToRuntime(runtime));
            yield initProjectForVSCode_1.initProjectForVSCode(actionContext, functionAppPath, language, runtime, projectCreator);
...
function getProjectCreator(language, functionAppPath, actionContext) {
    switch (language) {
        case constants_1.ProjectLanguage.Java:
            return new JavaProjectCreator_1.JavaProjectCreator(functionAppPath, actionContext);
        case constants_1.ProjectLanguage.JavaScript:
            return new JavaScriptProjectCreator_1.JavaScriptProjectCreator(functionAppPath, actionContext.properties);
        case constants_1.ProjectLanguage.CSharp:
            return new CSharpProjectCreator_1.CSharpProjectCreator(functionAppPath, actionContext.properties);
        case constants_1.ProjectLanguage.CSharpScript:
            return new CSharpScriptProjectCreator_1.CSharpScriptProjectCreator(functionAppPath, actionContext.properties);
        case constants_1.ProjectLanguage.Python:
            return new PythonProjectCreator_1.PythonProjectCreator(functionAppPath, actionContext.properties);
        default:
            return new ScriptProjectCreatorBase_1.ScriptProjectCreatorBase(functionAppPath, actionContext.properties);
    }
}
