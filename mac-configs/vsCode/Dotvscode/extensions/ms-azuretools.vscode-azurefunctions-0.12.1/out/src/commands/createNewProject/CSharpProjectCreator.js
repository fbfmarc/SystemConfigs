...
class CSharpProjectCreator extends IProjectCreator_1.ProjectCreatorBase {
    ...
    addNonVSCodeFiles(runtime) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._runtime = runtime || (yield tryGetLocalRuntimeVersion_1.tryGetLocalRuntimeVersion()) || (yield ProjectSettings_1.promptForProjectRuntime());
