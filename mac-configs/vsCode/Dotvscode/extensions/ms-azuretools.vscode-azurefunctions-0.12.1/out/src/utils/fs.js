...
function copyFolder(fromPath, toPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const file of files) {
            ...
            if (stat.isFile()) {
                if (yield confirmOverwriteFile(targetPath)) {
                    yield fse.copy(originPath, targetPath, { overwrite: true });
                }
            }
            else if (stat.isDirectory()) {
                yield copyFolder(originPath, targetPath);
            }
        }
    });
}
exports.copyFolder = copyFolder;
function confirmEditJsonFile(fsPath, editJson) {
    return __awaiter(this, void 0, void 0, function* () {
        let newData;
        if (yield fse.pathExists(fsPath)) {
            try {
                ...
                if (yield confirmOverwriteFile(fsPath)) {
                    newData = editJson({});
                }
                else {
                    return;
...
function confirmOverwriteFile(fsPath) {
    return __awaiter(this, void 0, void 0, function* () {
        if (yield fse.pathExists(fsPath)) {
            const result = yield extensionVariables_1.ext.ui.showWarningMessage(localize_1.localize('azFunc.fileAlreadyExists', 'File "{0}" already exists. Overwrite?', fsPath), { modal: true }, vscode_azureextensionui_1.DialogResponses.yes, vscode_azureextensionui_1.DialogResponses.no, vscode_azureextensionui_1.DialogResponses.cancel);
