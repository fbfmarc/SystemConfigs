...
function getFunctionTemplates(source) {
    return __awaiter(this, void 0, void 0, function* () {
        const templatesMap = {};
            ...
            for (const key of Object.keys(constants_1.ProjectRuntime)) {
                ...
                yield vscode_azureextensionui_1.callWithTelemetryAndErrorHandling('azureFunctions.getFunctionTemplates', function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const useStagingTemplates = source === 'stagingCliFeed';
                        const templateVersion = yield tryGetTemplateVersionSetting(this, cliFeedJson, runtime, useStagingTemplates);
                        let templates;
                        // 1. Use the cached templates if they match templateVersion
                        if (!source && extensionVariables_1.ext.context.globalState.get(templateRetriever.getCacheKey(TemplateRetriever_1.TemplateRetriever.templateVersionKey, runtime)) === templateVersion) {
...
function tryGetTemplateVersionSetting(context, cliFeedJson, runtime, useStagingTemplates) {
    return __awaiter(this, void 0, void 0, function* () {
        const feedRuntime = getCliFeedJson_1.getFeedRuntime(runtime, useStagingTemplates);
