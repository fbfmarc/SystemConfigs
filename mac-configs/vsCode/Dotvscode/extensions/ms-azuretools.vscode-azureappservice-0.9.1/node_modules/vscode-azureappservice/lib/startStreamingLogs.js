...
function startStreamingLogs(client, verifyLoggingEnabled, logStreamLabel, logsPath = '') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (logStream && logStream.isConnected) {
            ...
            yield extensionVariables_1.ext.ui.showWarningMessage(localize_1.localize('logStreamAlreadyActive', 'The log-streaming service for "{0}" is already active.', logStreamLabel));
            return logStream;
        }
        else {
...
function stopStreamingLogs(client, logsPath = '') {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (logStream && logStream.isConnected) {
            ...
            yield vscode.window.showWarningMessage(localize_1.localize('alreadyActive', 'The log-streaming service for "{0}" is already disconnected.', logStream.outputChannel.name));
        }
    });
}
