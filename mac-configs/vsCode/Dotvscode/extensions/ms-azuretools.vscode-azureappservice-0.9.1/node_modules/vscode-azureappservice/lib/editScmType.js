...
function editScmType(client, node) {
    return __awaiter(this, void 0, void 0, function* () {
        const config = yield client.getSiteConfig();
        const newScmType = yield showScmPrompt(config.scmType);
        if (newScmType === ScmType_1.ScmType.GitHub) {
            ...
            yield connectToGitHub_1.connectToGitHub(node, client);
        }
        else {
...
function showScmPrompt(currentScmType) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const scmType of Object.keys(ScmType_1.ScmType)) {
