...
class AppServicePlanNameStep extends vscode_azureextensionui_1.AzureWizardPromptStep {
    ...
    validatePlanName(wizardContext, name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (wizardContext.resourceGroup && !(yield AppServicePlanListStep_1.AppServicePlanListStep.isNameAvailable(wizardContext, name, wizardContext.resourceGroup.name))) {
