...
import { IAzureUserInput, UIExtensionVariables } from 'vscode-azureextensionui';
/**
 ...
 */
export declare let ext: IAppServiceExtensionVariables;
/**
 * Call this to register common variables used throughout the AppService package.
 */
export declare function registerAppServiceExtensionVariables(extVars: IAppServiceExtensionVariables & UIExtensionVariables): void;
